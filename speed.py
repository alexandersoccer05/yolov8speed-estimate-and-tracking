        ...
        if id in vh_down:
           ...
           if cy2<(cy+offset) and cy2 > (cy-offset):
             ...
             if counter.count(id)==0:
                ...
                a_speed_kh = (a_speed_ms * 3.6) / 1.609
                cv2.circle(frame,(cx,cy),4,(0,0,255),-1)
                cv2.putText(frame,str(id),(x3,y3),cv2.FONT_HERSHEY_COMPLEX,0.6,(255,255,255),1)
                cv2.putText(frame,str(int(a_speed_kh))+'mph',(x4,y4 ),cv2.FONT_HERSHEY_COMPLEX,0.8,(0,255,255),2)
        ...
        if id in vh_up:
           ...
           if cy1<(cy+offset) and cy1 > (cy-offset):
             ...
             if counter1.count(id)==0:
                ...
                a_speed_kh1 = (a_speed_ms1 * 3.6) / 1.609
                cv2.circle(frame,(cx,cy),4,(0,0,255),-1)
                cv2.putText(frame,str(id),(x3,y3),cv2.FONT_HERSHEY_COMPLEX,0.6,(255,255,255),1)
                cv2.putText(frame,str(int(a_speed_kh1))+'mph',(x4,y4),cv2.FONT_HERSHEY_COMPLEX,0.8,(0,255,255),2)
